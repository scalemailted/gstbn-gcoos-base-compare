...
def draw_temporal_degree_centrality(degrees):
    ...
    for i in range(cols):
        ...
        if color == 'red':
            ...
            label = 'Old (first 75%)'
        plt.plot(unique[0:], counts[0:], '-o', color=color, alpha=a,label=label) #2022 --> [1:] to [2:]
        print(f"'Temporal Degree Centrality (per snapshot)'", unique, counts)
    plt.xlabel('Degree Count')
    plt.ylabel('Number of Nodes')
    plt.title('Temporal Degree Centrality (per snapshot)')
    #plt.xlim(left=0.95)
    ...
    #plt.show()
    plt.savefig(f"{folder}/temporal_degree_centrality.png")
    plt.close()
...
def draw_temporal_degree_centrality_overall(degree_totals):
    ...
    counts = [x for _,x in sorted(zip(uniques[0:],counts[0:]))] #2021-3-5 #VALIDATE, #2022 --> [1:] to [2:]
    uniques = sorted(uniques[0:]) #2021-3-5 #VALIDATE, #2022 --> [1:] to [2:]
    ...
    #plt.xlim(left=0.95)
    #plt.show()
    plt.savefig(f"{folder}/temporal_degree_centrality_overall.png")
    plt.close()
    print(f"'Temporal Degree Centrality (overall totals)'", uniques, counts)
...
def draw_topological_overlap_overall(overlaps):
    ...
    #plt.show()
    plt.savefig(f"{folder}/topological_overlap_overall.png")
    plt.close()
    print(f"'Topological Overlap - Network Measure'", x_vals, y_vals)
...
def draw_topological_overlap(overlaps):
    ...
    #plt.show()
    plt.savefig(f"{folder}/topological_overlap.png")
    plt.close()
    print(f"'Topological Overlap - Node Measure'", x, y)
...
def draw_topological_overlap_average(overlaps_averages):
    ...
    #plt.show()
    plt.savefig(f"{folder}/topological_overlap_average.png")
    plt.close()
    print(f"'Topological Overlap Average - Node Measure'", x_vals, y_vals)
...
def draw_temporal_correlation_coefficient(tcc):
    ...
    #plt.show()
    plt.savefig(f"{folder}/temporal_correlation_coefficient.png")
    plt.close()
    print(f"'Topological Overlap Average - Network Measure'", x_vals, y_vals)
